        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body" >
                    ...
                    <button id='adddonor' class="btn btn-primary" style="float:left">Add a Donor</button>
                    ...
                    <div id="myModal" class="modal">
                          ...
                          <div class="modal-content">
                                ...
                                <form class="form-horizontal" role="form" method="POST" action="{{ url('client/donor_added') }}">
                        {{ csrf_field() }}
                        <div class="form-group">
                    ...
                    <div id="myModal2" class="modal">
                          ...
                          <div class="modal-content">
                                ...
                                <form class="form-horizontal" role="form" method="GET" action="{{ url('clients_donors/search') }}">
                            <div class="form-group">
                ...
                <script>
                        ...
                        var btn = document.getElementById("adddonor");
